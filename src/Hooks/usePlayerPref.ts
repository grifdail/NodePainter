...
import { DefaultGradient, getDefaultPalette } from "../Data/Palettes";
    ...
    persist(
        (set, get) => {
            return {
                ...
                palettes: structuredClone(getDefaultPalette()),
                gradient: structuredClone(DefaultGradient),
                snippets: {},
                colorPreset: getDefaultPalette().Pico8,
                ...
                loadDefaultPaletteCollection() {
                    set((state) => ({
                        palettes: {
                            ...state.palettes,
                            ...structuredClone(getDefaultPalette()),
                        },
                        gradient: {
                            ...state.gradient,
                ...
                removeDefaultPalettes() {
                    set((state) => ({
                        palettes: Object.fromEntries(Object.entries(state.palettes).filter(([name]) => !getDefaultPalette()[name])),
