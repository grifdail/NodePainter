...
export const CMYKNode: NodeDefinition = {
    ...
    getData: (portId, node, context) => {
        const cyan = context.getInputValueNumber(node, "cyan");
        const magenta = context.getInputValueNumber(node, "magenta");
        const yellow = context.getInputValueNumber(node, "yellow");
        const black = context.getInputValueNumber(node, "black");
