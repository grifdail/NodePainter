...
export class StatefullInstance<TSave, TProps extends any[]> {
    ...
    update(virtual: StatefullVirtualElement<TSave, TProps>, root: any) {
        this.reconciliateChildren(this, virtual);
        this.virtual = virtual;
    ...
    reconciliateChildren<TSave, TProps extends any[]>(instance: StatefullInstance<TSave, TProps>, virtual: StatefullVirtualElement<TSave, TProps>) {
