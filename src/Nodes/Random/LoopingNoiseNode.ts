...
export const LoopingNoiseNode: NodeDefinition = {
    id: "Random/LoopingNoise",
    tags: ["Math"],
    ...
    getData: (portId, node, context) => {
        var pos = context.getInputValueNumber(node, "pos");
        var scale = context.getInputValueNumber(node, "scale");
        var seed = context.getInputValueVector(node, "seed");
