export type BasePortType = "number" | "vector" | "vector2" | "vector3" | "vector4" | "color" | "string" | "bool" | "image" | "gradient" | "material" | "mesh" | "struct";
export type PortType = "execute" | BasePortType | `array-${BasePortType}` | "unknown";
export const BasePortTypeArray: PortType[] = ["number", "vector2", "vector3", "vector4", "color", "string", "bool", "image", "gradient", "material", "mesh", "struct"];
...
export const CommonTypes: BasePortType[] = ["number", "vector2", "vector3", "color", "gradient", "image", "string", "material", "bool", "mesh", "struct"];
