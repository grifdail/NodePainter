...
import { EditableGradientPreview } from "./ChildComponents/EditableGradientPreview";
...
export const GradientSetting: SettingComponent<GradientSettingDefinition> = {
    UI: function ({ onChange, value, def }: SettingProps<GradientSettingDefinition>) {
