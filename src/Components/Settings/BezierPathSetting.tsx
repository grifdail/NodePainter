...
export const BezierPathSetting: SettingComponent<BezierPathSettingDefinition> = function PathSetting({ onChange, value, def }: SettingProps<BezierPathSettingDefinition>) {
...
BezierPathSetting.getSize = function (value, def): number {
  return 272 + 64;
};
