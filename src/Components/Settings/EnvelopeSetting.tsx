...
export const EnvelopeSetting: SettingComponent<EnvelopeSettingDefinition> = {
    UI: function GradientSetting({ onChange, value, def }: SettingProps<EnvelopeSettingDefinition>) {
