import { animated, SpringRef, SpringValue, useSpring, useSprings } from "@react-spring/web";
...
function useMoveNode(displayedNode: NodeData[], tree: TreeStore, nodePositionSpringApi: SpringRef<{ xy: number[] }>) {
    const displayedNodeKeys = Object.keys(displayedNode).join("-");
    return useCallback(
        ...
        [nodePositionSpringApi, displayedNodeKeys]
    );
}
